...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-90.132002, 13.155405, -87.684070, 14.450933],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-90.123484, 13.075735, -87.553156, 14.868177], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_sv_division_municipios_2023_2,
    colName: 'MUNICIPIO',
    zoom: 10,
    collapsed: true,
    map: map,
